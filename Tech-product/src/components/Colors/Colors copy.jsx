...
export default function Colors() {
  ...
  return (
    <section id="colors" className="colors-section relative px-8 py-32 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-7xl md:text-8xl text-white leading-none">CHOOSE</h2>
          <h2 className="font-display text-7xl md:text-8xl leading-none colors-gradient-text">YOUR COLOR</h2>
        </div>
        ...
        <div className="flex justify-center gap-4 mb-14">
          {colorOptions.map((c, i) => (
            <button
              key={c.slug}
              onClick={() => setActive(i)}
              className={`color-tab relative flex items-center gap-3 px-6 py-3 rounded-full font-semibold text-sm transition-all duration-300 ${
            ...
            >
              {/* Color dot */}
              <span
                className="w-4 h-4 rounded-full flex-shrink-0 ring-2 ring-offset-1 ring-offset-transparent"
                style={{ background: c.accent, boxShadow: `0 0 10px ${c.glow}`, ringColor: c.accent }}
              />
              {c.name}
              {c.tag && (
                <span
        ...
        <div className="colors-display grid md:grid-cols-2 gap-16 items-center">
          {/* Phone image */}
          ...
          <div className="colors-info">
            <div
              className="colors-color-chip w-16 h-2 rounded-full mb-6"
            ...
            <a
              href="#order"
              className="inline-flex items-center gap-2 text-white font-bold px-10 py-4 rounded-full transition-all duration-300"
              style={{
